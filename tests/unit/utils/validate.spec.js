...
describe('Utils:validate', () => {
  ...
  it('validURL', () => {
    expect(validURL('https://github.com/MdSobhanian/vue-element-admin')).toBe(true)
    expect(validURL('http://github.com/MdSobhanian/vue-element-admin')).toBe(true)
    expect(validURL('github.com/MdSobhanian/vue-element-admin')).toBe(false)
  })
  it('validLowerCase', () => {
